...
class Cliente extends Pessoa {
    constructor(id, nome, genero, cpf, dtNascimento, cidade, uf, formaPgto, fone, endereco, pedido) {
...
class Pedido {
    constructor(id, desc ,valorTotal, horaPedido, dtPedido, produtos) {
        this.id = id;
        this.desc = desc;
...
class Produto {
    constructor(id, nome, marca, preco, desconto, precoN, descontoN) {
        this.id = id;
        this.nome = nome;
        this.marca = marca;
        this.preco = preco;
