...
function tema_claro() {
    ...
    body.setAttribute("style", "background-image: url(../texturas/textura_de_madeira_clara.png)");
...
function tema_escuro() {
    ...
    let body = document.querySelector("body");
    body.setAttribute("style", "background-image: url(../texturas/textura_de_madeira_escura.png)");
