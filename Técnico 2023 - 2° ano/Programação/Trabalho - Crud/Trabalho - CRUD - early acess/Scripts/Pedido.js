...
function Data() {
    ...
    if (nome == "" || valorTotal == "" || horaPedido == "" || dtPedido == "") {
        alert('Por favor preencha todos os campos.');
        return;
    } else {

        var pedido = new Pedido(gerarID(), nome, valorTotal, horaPedido, dtPedido);
